...
AKT.widgets.diagram.setup = function (widget) {
    ...
    var paper = new joint.dia.Paper({ el: $('#paper'), width: 1100, height: 600, gridSize: 1, model: graph, linkPinning:false });
    paper.scale(1);
...
// ===========================  JOINT HANDLERS  ===============================
    ...
    paper.on('link:mouseenter', function(linkView) {
        ...
        $(widget.element).find('.popup').html(AKT.KBs.atwima._statements[linkView.model.id].english);
    });
...
<div class="content" style="border:none;padding:5px;">
    ...
    <div class="top_div" style="width:100%; background:#d4d0c8;"></div>
        ...
        <select class="listbox_topics" style="float:left;"></select>
    ...
    <div class="main_div w3-row">
        ...
        <!-- =========== diagram div =================== -->
        <div id="paper" class="w3-rest w3-container paper" style="background:white; width:700px; height:600px;"></div>
