...
AKT.widgets.diagram.setup = function (widget) {
    ...
    var paper = new joint.dia.Paper({ el:$('#paper'), width:880, height:460, gridSize:1, 
        model:graph, linkPinning:false });
    paper.scale(1);
    initialiseJointjs(graph, paper, widget);


    // ========================================================================================
    // Handlers for dialog window buttons
