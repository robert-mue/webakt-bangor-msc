(function ($) {
   ...
   */
    $.widget('akt.diagram', {
        ...
        _create: function () {
            console.log('\n### Creating instance of widget "akt.diagram".',
...
*/
    ...
    function evaluate(kb) {
        console.log('Starting akt.diagram: evaluate()');
        return null;
    }


    function display(widget, results) {
        console.log('Starting akt.diagram: display()');
...
*/
        $(topDiv).append(
            ...
            '<input type="button" style="float:left;margin-left:10px;" id="'+instance+'_save" class="diagram_save" value="Save">'+
            '<input type="button" style="float:left;margin-left:10px;" id="'+instance+'_load" class="diagram_load" value="Load">'+
            '<input type="button" onclick="layout();" style="float:left;margin-left:3%;" id="'+instance+'_menu" value="Menu">');

        // The <div> panels holding the left and right controls, and the diagram between them.
        ...
        //var diagramDiv = $('<div id="'+instance+'_diagram_div" class="w3-rest w3-container" style="background:white; height:90%;"></div>');
        //var diagramDiv = $('<div id="diagram" class="w3-rest w3-container" style="oveflow:scroll; background:pink; width:600px;height:600px;"></div>');
        var diagramDiv = $('<div id="paper" class="w3-rest w3-container paper" style="background:white; height:90%;"></div>');
        $(mainDiv).append(leftDiv).append(rightDiv).append(diagramDiv);

       // Left-hand panel
       $(leftDiv).append(
        '<fieldset style="position:static;">'+
            '<legend>Add node</legend>'+
            '<input type="button" id="'+instance+'_add_object" class="diagram_button_left node_object" value="Object"><br>'+
            '<input type="button" id="'+instance+'_add_attribute" class="diagram_button_left node_attribute" value="Attribute"><br>'+
            '<input type="button" id="'+instance+'_add_process" class="diagram_button_left node_process" value="Process"><br>'+
            '<input type="button" id="'+instance+'_add_action" class="diagram_button_left node_action" value="Action"><br>'+
         '</fieldset>');
        $(leftDiv).append(
        '<fieldset style="position:static;">'+
            '<legend>Add link</legend>'+
            '<input type="button" id="'+instance+'_add_causes1way" class="diagram_button_left link_causes1way" value="Causes1way" style="width:60px;"><br>'+
            '<input type="button" id="'+instance+'_add_causes2way" class="diagram_button_left link_causes2way" value="Causes2way" style="width:60px;"><br>'+
            '<input type="button" id="'+instance+'_add_link" class="diagram_button_left link_link" value="Link" style="width:60px;"><br>'+
         '</fieldset>');
        $(leftDiv).append(
        '<fieldset style="position:static;">'+
            '<legend>Delete</legend>'+
            '<input type="button" id="'+instance+'_delete_node_or_link" class="diagram_button_left" value="Node/Link" style="width:60px;"><br>'+
         '</fieldset>');
        $(leftDiv).append(
        '<fieldset style="position:static;">'+
            '<legend>Hide</legend>'+
            '<input type="button" id="'+instance+'_hide_node_or_link" class="diagram_button_left" value="Node/Link" style="width:60px;"><br>'+
         '</fieldset>');
        $(leftDiv).append(
        '<fieldset style="position:static;">'+
            '<legend>Show/Hide</legend>'+
            '<input type="button" id="'+instance+'_show_hide_label" class="diagram_button_left" value="Label" style="width:60px;"><br>'+
         '</fieldset>');
        ...
        '<fieldset style="position:static;">'+
            '<legend>Zoom</legend>'+
            '<input type="button" id="'+instance+'_zoom_in" class="diagram_button_right" value="Zoom in">'+
            '<input type="button" id="'+instance+'_zoom_out" class="diagram_button_right" value="Zoom out">'+
            '<input type="button" id="'+instance+'_centre_zoom" class="diagram_button_right" value="Centre Zoom">'+
         '</fieldset>');
        ...
        $(rightDiv).append(
        '<fieldset style="position:static;">'+
            '<input type="button" id="'+instance+'_refresh" class="diagram_button_right" value="Refresh">'+
            '<input type="button" id="'+instance+'_show_paths" class="diagram_button_right" value="Show Paths">'+
            '<input type="button" id="'+instance+'_print_window" class="diagram_button_right" value="Print Window">'+
            '<input type="button" id="'+instance+'_statements" class="diagram_button_right" value="Statements">'+
        '<fieldset>');
        $(rightDiv).append(
        '<fieldset style="position:static;">'+
            '<legend>Explore</legend>'+
            '<input type="button" id="'+instance+'_navigate" class="diagram_button_right" value="Navigate">'+
            '<input type="button" id="'+instance+'_sources" class="diagram_button_right" value="Sources">'+
            '<input type="button" id="'+instance+'_causes" class="diagram_button_right" value="Causes">'+
            '<input type="button" id="'+instance+'_effects" class="diagram_button_right" value="Effects">'+
            '<input type="button" id="'+instance+'_undo" class="diagram_button_right" value="Undo">'+
         '</fieldset>');
        $(rightDiv).append(
        '<fieldset style="position:static;">'+
            '<legend>Select Diagram</legend>'+
            //'<label for="'+instance+'_select_diagram_left">&lt;</label>'+
            '<input type="button" id="'+instance+'_select_diagram_left" style="float:left; width:44px;" value="&lt;">'+
            '<input type="button" id="'+instance+'_select_diagram_right" style="float:left; width:44px;" value="&gt;">'+
         '</fieldset>');

        $('.diagram_button_left').css({width:'80px',padding:'2px'});
        $('.diagram_button_right').css({width:'90px',padding:'3px'});

        var nodeDialog = $('<div class="diagram_node_dialog" '+
            'style="width:100px;height:100px;background:yellow;display:none;">Node dialog</div>');
        var linkDialog = $('<div class="diagram_link_dialog" '+
