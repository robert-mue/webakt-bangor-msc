...
class ObjectHierarchy {
    ...
    constructor(spec) {
        this._id = spec.type;
        var tree = this.makeTree(spec.type,spec.links);
...
// Note that AKT5 talks about topic HIERARCHIES, not hierarchy; ditto objects.
...
// bit more readable.
    makeTree = function (hierarchyId,links) {
        var treeDown = {};
        var treeUp = {};
